...
This is an implementation of the GA4GH Beacon v2 standard for genomic data discovery ([about](https://www.ga4gh.org/product/beacon-api/) | [specification](https://github.com/ga4gh-beacon/beacon-v2) | [API documentation](https://docs.genomebeacons.org/)) for the [Bento platform](https://bento-platform.github.io/).
...
Configuration is done through the [Bento application](https://github.com/bento-platform/bento), see in particular the instructions [here](https://github.com/bento-platform/bento). The beacon can be accessed through a user interface on the [bento public](https://github.com/bento-platform/bento_public) portal, or run as a back-end only API.
